...
shenhei:function(e){
	var that=this
	var shtypes=e.currentTarget.dataset.shtypes
	var contents=''
	if(shtypes==1){
		contents='确认要通过该信息吗'
	}else{
	...
	var url = 'User/shenheikehu'
	  var params = { id: e.currentTarget.dataset.id,shtypes:shtypes,
	...
	success: function () {
	  setTimeout(function() {
  that.setData({ listdatas: data.listdatas})
